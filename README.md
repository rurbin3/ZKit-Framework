...
It can generate Ransomware ,  Rootkit ( Reverse Shell And File Transfer) , Run Dos Attack , With Colorful Controlers And can fool Avs with Random variable names , encryption of malware and decrypting in run 
